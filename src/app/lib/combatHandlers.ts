...
import { resolveCombatSlot } from './fieldOperations';
import { opponentOf } from './gameSelectors';
import type { CombatResolution, FieldSlot, PlayerState } from './gameStateTypes';
import { advancePhaseState } from './phaseHandlers';
import { getSpotlightAdjustedValue } from './spotlight';
import { applyCombatModifierStatuses, getCombatModifierStatuses } from './statusEffects';
 ...
 */
export function handleResolveCombat(state: GameState, coringaQCopyTargetId?: string): GameState {
 ...
 */
export function handleFinalizeCombat(state: GameState): GameState {
